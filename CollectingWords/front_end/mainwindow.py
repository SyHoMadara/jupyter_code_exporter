...
class Ui_TabWidget(object):
    def setupUi(self, TabWidget):
        ...
        self.comboBoxSpliter.setGeometry(QtCore.QRect(690, 100, 111, 22))
        ...
        self.lineEditCustomSpliter.setGeometry(QtCore.QRect(690, 130, 111, 22))
        ...
        self.labelWarnings.setGeometry(QtCore.QRect(30, 340, 371, 41))
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.lineEditEncode = QtWidgets.QLineEdit(self.collecting)
        self.lineEditEncode.setGeometry(QtCore.QRect(470, 300, 111, 31))
        self.lineEditEncode.setStyleSheet("font: 75 10pt \"MS Shell Dlg 2\";")
        self.lineEditEncode.setObjectName("lineEditEncode")
        self.label_9 = QtWidgets.QLabel(self.collecting)
        self.label_9.setGeometry(QtCore.QRect(470, 280, 55, 16))
        self.label_9.setObjectName("label_9")
        self.widget = QtWidgets.QWidget(self.collecting)
        self.widget.setGeometry(QtCore.QRect(540, 30, 259, 59))
        self.widget.setObjectName("widget")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.checkBoxSortWords = QtWidgets.QCheckBox(self.widget)
        self.checkBoxSortWords.setObjectName("checkBoxSortWords")
        self.verticalLayout_3.addWidget(self.checkBoxSortWords)
        self.checkBoxMakeUniqWords = QtWidgets.QCheckBox(self.widget)
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.checkBoxNonAlphabetChar.setText(_translate("TabWidget", "All"))
        ...
        self.lineEditEncode.setText(_translate("TabWidget", "utf-8"))
        self.label_9.setText(_translate("TabWidget", "Encode"))
        ...
        self.comboBoxDetection.setItemText(0, _translate("TabWidget", "Enter"))
        self.comboBoxDetection.setItemText(1, _translate("TabWidget", "Space"))
